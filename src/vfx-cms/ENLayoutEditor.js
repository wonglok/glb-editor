  ...
  return (
    <div className='flex flex-col w-full h-full'>
      <div
        ...
        className='relative flex items-center justify-between w-full bg-gray-100 border-b border-solid'
      >
        <div className='px-1'>
      ...
      <div
        ...
        className='relative flex items-stretch justify-start w-full'
      >
...
function ViewSettings() {
  return (
    <div>
      <div
        className='inline-block p-2 m-1 bg-white border cursor-pointer'
        onClick={() => {
          //
